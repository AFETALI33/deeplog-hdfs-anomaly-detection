...
spec = importlib.util.spec_from_file_location(
    "model",
    "/content/drive/MyDrive/DeepLog3.0/02_model.py"
)
...
# ─── CONFIGURATION ────────────────────────────────────────────────────────────
CFG = {
    # ⚠ Changer ce chemin selon le pipeline utilisé :
    # Pipeline v2 (Drain3, vocab=101) : "/content/drive/MyDrive/data_finale/"
    # Pipeline v3 (CSV LogPai, vocab=30) : "/content/drive/MyDrive/data_finale_v3/"
    "data_path"     : "/content/drive/MyDrive/data_finale_v3/",

    # ⚠ Changer ce chemin pour ne pas écraser les checkpoints v2
    "checkpoint_dir": "/content/drive/MyDrive/DeepLog3.0/checkpoints_v3/",
...
def main():
    ...
    CFG["vocab_size"] = load_vocab_size(CFG["data_path"], default=101)
